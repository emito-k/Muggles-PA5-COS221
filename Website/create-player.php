...
<html>
    ...
    <body>
        ...
        <div class="w3-container" style="padding-top:50px;">
            <h1 style="font-family:lucida handwriting; text-align:center;">Create Player</h1>
            <hr>
            <br>
            <form action="./player.php" method="post" style="text-align:center;">
                ...
                <input type="date" id="birthday" name="birthday" required style="width:210px;"><br><br>
                ...
                <select style="width:210px;" name="timezone" id="timezone">
